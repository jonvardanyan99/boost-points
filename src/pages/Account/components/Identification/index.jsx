...
export const Identification = () => {
  ...
  useEffect(() => {
    if (data) {
      const documentType = DOCUMENT_TYPE_OPTIONS.find(option => option.value === data.documentType);
      const state = STATE_OPTIONS.find(option => option.value === data.documentData.state);
